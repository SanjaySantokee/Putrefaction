...
/**
    The Animation class manages a series of assets.images (frames) and
    the amount of time to display each frame.
*/

public class Animation extends Sprite {

    protected ArrayList frames;		// collection of assets.images for animation frames
...
/**
    ...
    animation has no assets.images.
*/
